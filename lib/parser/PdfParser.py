...
from lib.third.pdfminer.pdfparser import PDFParser, PDFDocument, PDFPage
from lib.third.pdfminer.pdfinterp import PDFResourceManager, PDFPageInterpreter, PDFTextExtractionNotAllowed
                ...
                for x in layout:
                    if (isinstance(x, LTTextBoxHorizontal)):
                        ...
                        if check_raw:
                            ...
                            ### 新增内容开始 ###
                            sensitive_words = self.sensitive_word_search(check_raw)
                            if sensitive_words:
